...
internal class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        using (IRepository repository = Repository.Create("Celebrities"))
        {
            ...
            // Если метод возвращает значение, не равное -1, значит обновление прошло успешно.
            ...
            if (repository.updCelebrityById(1000, new Celebrity(0, "Updated1000", "Updated1000", "Photo/Update1000.jpg")) != -1)
            {
